...
class HookLogPanel {
    ...
    show(focusHookId) {
        if (!this.panel) {
            this.panel = vscode.window.createWebviewPanel("fridaHookLog", "Hook Log", vscode.ViewColumn.Beside, { enableScripts: true, retainContextWhenHidden: true });
...
exports.HookLogPanel = HookLogPanel;
