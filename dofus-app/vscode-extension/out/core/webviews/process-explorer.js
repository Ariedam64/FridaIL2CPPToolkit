...
exports.ProcessExplorerPanel = void 0;
const vscode = __importStar(require("vscode"));
class ProcessExplorerPanel {
    rpc;
    profileSource;
    profileEvents;
    panel = null;
    labelChangeSub = null;
    annotationChangeSub = null;
    profileChangeSub = null;
    constructor(rpc, profileSource, profileEvents) {
        this.rpc = rpc;
    ...
    show() {
        ...
        this.panel = vscode.window.createWebviewPanel("fridaProcessExplorer", "Process Explorer", vscode.ViewColumn.Beside, { enableScripts: true, retainContextWhenHidden: true });
    ...
    async sendNamespaces(assembly) {
        try {
            const list = await this.rpc.call("listNamespaces", [assembly]);
    ...
    async sendClasses(assembly, ns) {
        try {
            const list = await this.rpc.call("listClassesIn", [assembly, ns]);
            const profile = this.profileSource.current();
...
exports.ProcessExplorerPanel = ProcessExplorerPanel;
//# sourceMappingURL=process-explorer.js.map